<?php
    ...
    if(isset($_POST['modifier'])){
        $pass = filter_var(htmlentities($_POST['pass']),FILTER_SANITIZE_STRING);
        $nvpass = filter_var(htmlentities($_POST['nvpass']),FILTER_SANITIZE_STRING);
        $cnvpass = filter_var(htmlentities($_POST['cnvpass']),FILTER_SANITIZE_STRING);
