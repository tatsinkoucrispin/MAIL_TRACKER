<?php
    ...
    if(isset($_POST['mExp'])){
        ...
        if($nom==null || $adresse==null){
            ...
            $expsql = "UPDATE expediteur SET NOM_EXP = :nom, ADRESSE_EXP = :adresse, TEL_EXP = :tele, FAX_EXP = :fax where ID_EXP = '$id'";
                ...
                Expéditeur modifié avec succès!
             </div>";
        }
    }
					...
					<div class="details">
						<div class="recentOrders">
							<div class="cardHeader">
								<h2>Modification d'un expéditeur</h2><br>
							</div>
		
                        <form action="" method="POST">
                        <?php 
                                $sql = "SELECT * FROM expediteur where ID_EXP = '$id'";
                            ...
                            <div class="mb-3">
                                <label>Nom :</label>
                                <input type="text" value="<?php echo $value['NOM_EXP']?>" name="nom" class="form-control">
                            </div>
                            <div class="mb-3">
                                <label>Adresse :</label>
                                <input type="text" value="<?php echo $value['ADRESSE_EXP']?>" name="adresse" class="form-control">
                            </div>
                            <div class="mb-3">
                                <label>N&#186; Tele :</label>
                                <input type="tel" value="<?php echo $value['TEL_EXP']?>" name="tele" class="form-control">
                            </div>
                            <div class="mb-3">
                                <label>Fax :</label>
                                <input type="tel" value="<?php echo $value['FAX_EXP']?>" name="fax" class="form-control">
                            </div>
                            <?php }?>
                            <div class="mb-4">
                                <button type="submit" name="mExp" class="btn btn-success btn-lg">Modifier</button>
                                <button type="submit" name="" class="btn btn-danger"><a href="expediteur.php">Annuler</a></button>
                            </div>
