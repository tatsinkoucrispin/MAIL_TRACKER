					...
					<div class="details">
						<div class="recentOrders">
							<div class="cardHeader">
								...
								<a href="ajouterDep.php" class="btn">Nouveau département</a>
							</div>
                            ...
                            <table id="example" class="table table-striped">
                                ...
                                $dep = $conn->prepare($sql);
                                $dep->execute();
                                $tabDep=$dep->fetchAll(PDO::FETCH_ASSOC);
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="modifierDep.php?modifier=<?php echo $value['ID_DEPARTEMENT']; ?>"><button type="button" class="btn"><i class='bx bxs-edit'></i></button></a>
