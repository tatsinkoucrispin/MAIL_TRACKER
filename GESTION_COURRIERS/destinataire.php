								...
								<h3>Liste des destinataires</h3>
                                    ...
                                    <?php 
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo $value['TEL_DES']?></td>
                                            <td><?php echo $value['FAX_DES']?></td>
                                            <td>
                                                <a href="modifierDES.php?modifier=<?php echo $value['ID_DES']; ?>"><button type="button" class="btn"><i class='bx bxs-edit'></i></button></a>
                                            </td>
