					...
					<div class="details">
						<div class="recentOrders">
							<div class="cardHeader">
								<h2>Edition des courriers départs</h2><br>
							</div>
                            ...
                            <form action="table.php" method="POST">
                                ...
                                <div class="col mb-4">
                                        <label>Type :</label>
                                        <select name="typeCD" class="form-control">
                                            <option value="" selected disabled hidden>Type du courrier</option>
                                            <option value="CDI">Courrier interne</option>
                                            <option value="CDE">Courrier externe</option>
                                        </select>
                                </div>
                                <div class="mb-3">
                                    <label>Année :</label>
                                ...
                                <div class="mb-5">
									...
									<option selected disabled hidden>Sélectionner un département</option>
                                        <?php
                                        foreach($tabDepartement as $value) {
                                        ?>
                                        <option><?php echo $value['NOM_DEPARTEMENT'];?></option>
                                        <?php };?>
                                    </select>
                            </div>
                                <div class="mb-4">
                                    <button type="submit" name="filtrerCD" class="btn btn-success btn-lg">Valider</button>
                                    <button type="submit" name="" class="btn btn-danger"><a href="filtreCD.php">Annuler</a></button>
                                </div>
