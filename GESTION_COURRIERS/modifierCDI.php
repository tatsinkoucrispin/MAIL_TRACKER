<?php
    ...
    if(isset($_POST['ModifierCDI'])){
        ...
        if($num==null || $annee==null || $objet==null || $date==null || $reponse==null || $personneEmetteur==null || $departementEmetteur==null || $personneRecepteur==null || $departementRecepteur==null){
            ...
            $csql = "UPDATE courrier_depart_int SET N_DEPART_INT=:ndepart,ID_DEPARTEMENT=:iddep,ANNEE=:annee,OBJET_DAPART_INT=:objet,DATE_DEPART_INT=:dated,PIECE_JOINTE_DEPART_INT=:pj,REPONSE=:reponse WHERE N_DEPART_INT='$ncdi'";
            ...
            $transsql = "UPDATE transmettre3 SET ID_PERSONNEL=:idper,N_DEPART_INT=:ndepart WHERE N_DEPART_INT='$ncdi'";
            ...
            foreach($personneRecepteur as $pers){
                    $transsql = "UPDATE recevoir_interne SET ID_PERSONNEL=:idper,N_DEPART_INT=:ndepart WHERE N_DEPART_INT='$ncdi'";
					...
					<div class="details">
						<div class="recentOrders">
							<div class="cardHeader">
								<h2>Modification d'un courrier départ interne</h2><br>
							</div>
		
                            <form action="<?php $_SERVER['PHP_SELF'] ?>" method="POST" enctype="multipart/form-data">
                            <?php
                                        $reqCDI = "SELECT * from courrier_depart_int WHERE N_DEPART_INT='$ncdi'";
                                        $exCDI = $conn->prepare($reqCDI);
                                        $exCDI->execute();
                                        $cdi=$exCDI->fetchAll(PDO::FETCH_ASSOC);
                            ...
                            <div class="row g-5 mb-3">
                                ...
                                <div class="col">
                                    ...
                                    <input type="text" value="<?php echo $value['N_DEPART_INT']?>" name="ndepart" class="form-control" readonly>
                                </div>
                                <div class="col">
                                    <label>Annee *</label>
                            ...
                            <div class="row g-5 mb-3">
                                <div class="col">
                                    ...
                                    <input type="date" value="<?php echo $value['DATE_DEPART_INT']?>" name="date" class="form-control">
                                </div>
                                <?php }?>
                                <div class="col">
                            ...
                            <div class="row g-3 mb-3">
                                ...
                                <div class="col">
                                    <label for="">Personnel emetteur*</label>
                            ...
                            <div class="row g-3 mb-3">
                                ...
                                <div class="col">
                                    <label for="">Personnel recepteur*</label>
                            ...
                            <div class="mb-4">
                                    <button type="submit" name="ModifierCDI" class="btn btn-success btn-lg">Modifier</button>
                                    <button type="submit" name="" class="btn btn-danger"><a href="listeCDI.php">Annuler</a></button>
                                </div>
                        </form>
						</div>
