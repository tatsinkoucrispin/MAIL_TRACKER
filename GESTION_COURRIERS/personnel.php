					...
					<div class="details">
						<div class="recentOrders">
							<div class="cardHeader">
								...
								<a href="ajouterPer.php" class="btn">Ajout du personnel</a>
							</div>
                                    ...
                                    <table id="example" class="table table-striped">
                                            ...
                                            <?php 
                                $sql = "SELECT * FROM personnel p JOIN departement d on p.ID_DEPARTEMENT=d.ID_DEPARTEMENT";
                                ...
                                <tr>
                                    ...
                                    <td><?php echo $value['ADRESSE_PERSONNEL']?></td>
                                    <td><?php echo $value['TEL_PERSONNEL']?></td>
                                    <td><?php echo $value['NOM_DEPARTEMENT']?></td>
                                    <td>
                                        <a href="modifierPer.php?modifier=<?php echo $value['ID_PERSONNEL']; ?>"><button type="button" class="btn"><i class='bx bxs-edit'></i></button></a>
                                    </td>
